...
| 維度 | MemPalace | Hermes Agent |
|------|-----------|-------------|
| 擅長的記憶類型 | 情節記憶（逐字對話回溯） | 程序記憶（如何做事）+ 個人偏好 |
| 學習能力 | 被動儲存 | 主動學習循環，自動生成 Skills |
| 最佳使用情境 | 「我上次說了什麼？」 | 「這類任務怎麼做最好？」 |
| 授權 | MIT | MIT |

兩者不互斥：MemPalace 記日記，Hermes 沉澱技能。

詳見 [[wiki/tools/hermes-agent]]
